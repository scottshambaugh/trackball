class Trackball{#q0;#q;#azimuth;#elevation;#azimuth_start=0;#elevation_start=0;#drag=null;#isUpdatePending=false;#lastMousePosition=null;#opts;constructor(opts={}){if(opts.nodeType)opts={scene:opts};if(typeof opts.scene==='string'){opts.scene=document.querySelector(opts.scene);}
...
this.#q=Quaternion.fromEuler(this.#elevation,this.#azimuth,0,'XYZ');}#isInBounds(x,y,box){return x>=box.left&&x<=box.right&&y>=box.top&&y<=box.bottom;}#draw(){this.#opts.onDraw.call(this,this.#q);}}